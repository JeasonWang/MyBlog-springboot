...
CREATE TABLE `sys_log` (
                           ...
                           `operate_url` varchar(255) NOT NULL DEFAULT '' COMMENT '操作的访问地址',
                           `operate_by` varchar(255) DEFAULT '' COMMENT '操作的浏览器',
                           PRIMARY KEY (`id`)
...
CREATE TABLE `tbl_comment` (
                               ...
                               PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='因为comment分为两种，一种是留言，一种是评论，这里搞成一张表是因为它们几乎是拥有相同的字段，我觉得没必要分成两张表来进行维护';
